...
public class DcrdataAgendasController {
    ...
    public ResponseEntity<List<DecredMemoriesAgendaResponse>>  getAgendaByDate() throws ParseException {
      return ResponseEntity.ok().body(this.dcrdataAgendaService.getAgendaByDate());
    } 
}
